 ...
 */
function infra_cache_no() //Depricated - подобная очивидность должна быть на уровне документации и явного кода
{
 ...
 */
function infra_cache_yes() //Depricated - подобная очивидность должна быть на уровне документации и явного кода
{
